"""
Accuracy test for Fast Correlation-Based Filter.
Extracting features from MNIST dataset and using Naive Bayes Classifier.
FCBF_module can be found at https://github.com/SantiagoEG/FCBF_module
"""
